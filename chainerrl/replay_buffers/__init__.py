...
from chainerrl.replay_buffers.prioritized \
        import PrioritizedReplayBuffer  # NOQA
from chainerrl.replay_buffers.prioritized import PriorityWeightError  # NOQA
from chainerrl.replay_buffers.prioritized_episodic \
        import PrioritizedEpisodicReplayBuffer  # NOQA
