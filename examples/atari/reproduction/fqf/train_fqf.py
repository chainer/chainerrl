...
def main():
    ...
    parser.add_argument('--batch-accumulator', type=str, default='mean',
                        choices=['mean', 'sum'])
    parser.add_argument('--quantile-thresholds-N', type=int, default=32)
    ...
    q_func = chainerrl.agents.fqf.FQQFunction(
    ...
    # Lower the learning rate for the proposal network
    q_func.proposal_net.W.update_rule.alpha = 1e-5
    q_func.proposal_net.b.update_rule.alpha = 1e-5
